...
class BuildVersion extends BaseConfig
{
    ...
    public string $BUILD_ID       = '20260819.001';
    public string $COMMIT_ID     = '0db9122';
    public string $DEPLOYED_AT   = '2026-08-19 08:54:00';
    ...
    public const BUILD_ID        = '20260819.001';
    public const COMMIT_ID      = '0db9122';
    public const DEPLOYED_AT    = '2026-08-19 08:54:00';
