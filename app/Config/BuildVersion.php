...
class BuildVersion extends BaseConfig
{
    ...
    public string $BUILD_ID       = '20260819.003';
    public string $COMMIT_ID     = 'cc41dee';
    public string $DEPLOYED_AT   = '2026-08-19 09:55:00';
    ...
    public const BUILD_ID        = '20260819.003';
    public const COMMIT_ID      = 'cc41dee';
    public const DEPLOYED_AT    = '2026-08-19 09:55:00';
