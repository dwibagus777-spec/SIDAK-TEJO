...
class BuildVersion extends BaseConfig
{
    ...
    public string $BUILD_ID       = '20260819.019';
    public string $COMMIT_ID     = '4f7cf42';
    public string $DEPLOYED_AT   = '2026-08-19 18:21:00';
    ...
    public const BUILD_ID        = '20260819.019';
    public const COMMIT_ID      = '4f7cf42';
    public const DEPLOYED_AT    = '2026-08-19 18:21:00';
