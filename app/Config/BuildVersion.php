...
class BuildVersion extends BaseConfig
{
    ...
    public string $BUILD_ID       = '20260819.018';
    public string $COMMIT_ID     = '81d433e';
    public string $DEPLOYED_AT   = '2026-08-19 18:17:00';
    ...
    public const BUILD_ID        = '20260819.018';
    public const COMMIT_ID      = '81d433e';
    public const DEPLOYED_AT    = '2026-08-19 18:17:00';
