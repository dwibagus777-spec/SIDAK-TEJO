...
class BuildVersion extends BaseConfig
{
    ...
    public string $BUILD_ID       = '20260819.011';
    public string $COMMIT_ID     = 'c4752dc';
    public string $DEPLOYED_AT   = '2026-08-19 10:52:00';
    ...
    public const BUILD_ID        = '20260819.011';
    public const COMMIT_ID      = 'c4752dc';
    public const DEPLOYED_AT    = '2026-08-19 10:52:00';
