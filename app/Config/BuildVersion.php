...
class BuildVersion extends BaseConfig
{
    ...
    public string $BUILD_ID       = '20260820.001';
    public string $COMMIT_ID     = '3c47174';
    public string $DEPLOYED_AT   = '2026-08-20 11:01:00';
    ...
    public const BUILD_ID        = '20260820.001';
    public const COMMIT_ID      = '3c47174';
    public const DEPLOYED_AT    = '2026-08-20 11:01:00';
