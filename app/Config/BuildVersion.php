...
class BuildVersion extends BaseConfig
{
    ...
    public string $BUILD_ID       = '20260819.004';
    public string $COMMIT_ID     = '7db1e80';
    public string $DEPLOYED_AT   = '2026-08-19 10:10:00';
    ...
    public const BUILD_ID        = '20260819.004';
    public const COMMIT_ID      = '7db1e80';
    public const DEPLOYED_AT    = '2026-08-19 10:10:00';
