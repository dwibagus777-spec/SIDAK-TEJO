...
class BuildVersion extends BaseConfig
{
    ...
    public string $BUILD_ID       = '20260819.013';
    public string $COMMIT_ID     = '7242f49';
    public string $DEPLOYED_AT   = '2026-08-19 17:14:00';
    ...
    public const BUILD_ID        = '20260819.013';
    public const COMMIT_ID      = '7242f49';
    public const DEPLOYED_AT    = '2026-08-19 17:14:00';
