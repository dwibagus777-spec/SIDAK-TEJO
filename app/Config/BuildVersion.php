...
class BuildVersion extends BaseConfig
{
    ...
    public string $BUILD_ID       = '20260819.008';
    public string $COMMIT_ID     = 'bde4900';
    public string $DEPLOYED_AT   = '2026-08-19 10:38:00';
    ...
    public const BUILD_ID        = '20260819.008';
    public const COMMIT_ID      = 'bde4900';
    public const DEPLOYED_AT    = '2026-08-19 10:38:00';
