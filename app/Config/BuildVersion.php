...
class BuildVersion extends BaseConfig
{
    ...
    public string $BUILD_ID       = '20260819.016';
    public string $COMMIT_ID     = '4d7f138';
    public string $DEPLOYED_AT   = '2026-08-19 17:58:00';
    ...
    public const BUILD_ID        = '20260819.016';
    public const COMMIT_ID      = '4d7f138';
    public const DEPLOYED_AT    = '2026-08-19 17:58:00';
