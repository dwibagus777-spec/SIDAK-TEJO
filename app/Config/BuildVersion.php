...
class BuildVersion extends BaseConfig
{
    ...
    public string $BUILD_ID       = '20260819.010';
    public string $COMMIT_ID     = 'ad41dc0';
    public string $DEPLOYED_AT   = '2026-08-19 10:46:00';
    ...
    public const BUILD_ID        = '20260819.010';
    public const COMMIT_ID      = 'ad41dc0';
    public const DEPLOYED_AT    = '2026-08-19 10:46:00';
