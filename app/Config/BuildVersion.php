...
class BuildVersion extends BaseConfig
{
    ...
    public string $BUILD_ID       = '20260819.014';
    public string $COMMIT_ID     = '41c0d32';
    public string $DEPLOYED_AT   = '2026-08-19 17:24:00';
    ...
    public const BUILD_ID        = '20260819.014';
    public const COMMIT_ID      = '41c0d32';
    public const DEPLOYED_AT    = '2026-08-19 17:24:00';
