...
class BuildVersion extends BaseConfig
{
    ...
    public string $BUILD_ID       = '20260819.009';
    public string $COMMIT_ID     = '07218c2';
    public string $DEPLOYED_AT   = '2026-08-19 10:42:00';
    ...
    public const BUILD_ID        = '20260819.009';
    public const COMMIT_ID      = '07218c2';
    public const DEPLOYED_AT    = '2026-08-19 10:42:00';
