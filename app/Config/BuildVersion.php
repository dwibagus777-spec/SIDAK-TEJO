...
class BuildVersion extends BaseConfig
{
    ...
    public string $BUILD_ID       = '20260819.002';
    public string $COMMIT_ID     = '7141b3b';
    public string $DEPLOYED_AT   = '2026-08-19 09:12:00';
    ...
    public const BUILD_ID        = '20260819.002';
    public const COMMIT_ID      = '7141b3b';
    public const DEPLOYED_AT    = '2026-08-19 09:12:00';
