...
class BuildVersion extends BaseConfig
{
    ...
    public string $BUILD_ID       = '20260819.012';
    public string $COMMIT_ID     = 'b673a7d';
    public string $DEPLOYED_AT   = '2026-08-19 17:04:00';
    ...
    public const BUILD_ID        = '20260819.012';
    public const COMMIT_ID      = 'b673a7d';
    public const DEPLOYED_AT    = '2026-08-19 17:04:00';
