...
class BuildVersion extends BaseConfig
{
    ...
    public string $BUILD_ID       = '20260819.006';
    public string $COMMIT_ID     = 'a4f43f4';
    public string $DEPLOYED_AT   = '2026-08-19 10:30:00';
    ...
    public const BUILD_ID        = '20260819.006';
    public const COMMIT_ID      = 'a4f43f4';
    public const DEPLOYED_AT    = '2026-08-19 10:30:00';
