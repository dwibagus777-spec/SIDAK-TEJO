...
class BuildVersion extends BaseConfig
{
    ...
    public string $BUILD_ID       = '20260819.015';
    public string $COMMIT_ID     = '56e345f';
    public string $DEPLOYED_AT   = '2026-08-19 17:33:00';
    ...
    public const BUILD_ID        = '20260819.015';
    public const COMMIT_ID      = '56e345f';
    public const DEPLOYED_AT    = '2026-08-19 17:33:00';
