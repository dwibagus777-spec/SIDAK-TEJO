...
class BuildVersion extends BaseConfig
{
    ...
    public string $BUILD_ID       = '20260819.005';
    public string $COMMIT_ID     = '0a0ce03';
    public string $DEPLOYED_AT   = '2026-08-19 10:18:00';
    ...
    public const BUILD_ID        = '20260819.005';
    public const COMMIT_ID      = '0a0ce03';
    public const DEPLOYED_AT    = '2026-08-19 10:18:00';
