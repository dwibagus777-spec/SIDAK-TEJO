<?php
/**
 * Physical Asset Truth Layer & GIS Intelligence (CR-05 Phase 2)
 */
$summary = $summary ?? [
    'total_assets'          => 0,
    'master_feeders_count'  => 134,
...
<div class="container-fluid px-4">
    ...
    <div class="d-flex justify-content-between align-items-center mb-3">
        ...
        <div>
            <a href="<?= base_url('master-assets') ?>" class="btn btn-outline-primary btn-sm me-2"><i class="fa-solid fa-boxes-stacked me-1"></i> Master Asset Table</a>
        ...
        <div class="col-md-3">
            <div class="card-custom p-3">
                ...
                <div class="d-flex align-items-baseline mt-2">
                    ...
                    <span class="ms-2 badge <?= (!empty($summary['total_assets']) && $summary['total_assets'] > 0) ? 'bg-success' : 'bg-secondary' ?>">
                        <?= (!empty($summary['total_assets']) && $summary['total_assets'] > 0) ? 'POPULATED_TRUTH' : 'HONEST_ZERO_STATE' ?>
                    </span>
                </div>
