                ...
                <div class="card-body p-3">
                    <div class="d-flex align-items-center justify-content-between">
                        <div>
                            ...
                            <h2 class="fw-bold mb-0 font-outfit" style="color: #0f172a !important; font-size: 1.75rem;"><?= number_format($stats['total'] ?? 0) ?></h2>
                        </div>
                ...
                <div class="card-body p-3">
                    <div class="d-flex align-items-center justify-content-between">
                        <div>
                            ...
                            <h2 class="fw-bold mb-0 font-outfit" style="color: #0f172a !important; font-size: 1.75rem;"><?= number_format($stats['normal'] ?? 0) ?></h2>
                        </div>
                ...
                <div class="card-body p-3">
                    <div class="d-flex align-items-center justify-content-between">
                        <div>
                            ...
                            <h2 class="fw-bold mb-0 font-outfit" style="color: #0f172a !important; font-size: 1.75rem;"><?= number_format($stats['bermasalah'] ?? 0) ?></h2>
                        </div>
                ...
                <div class="card-body p-3">
                    <div class="d-flex align-items-center justify-content-between">
                        <div>
                            ...
                            <h2 class="fw-bold mb-0 font-outfit" style="color: #0f172a !important; font-size: 1.75rem;"><?= number_format($stats['critical'] ?? 0) ?></h2>
                        </div>
        ...
        <div class="card-body p-4">
            <div class="d-flex align-items-center justify-content-between mb-3 flex-wrap gap-2">
                ...
                <div class="d-flex gap-2">
                    <button type="button" class="btn btn-outline-danger btn-sm rounded-pill font-weight-bold shadow-sm" data-bs-toggle="modal" data-bs-target="#modalBulkDelete">
                        <i class="fas fa-trash-can me-1"></i> Hapus Massal
                    </button>
                        ...
                        <?php else: ?>
                            <?php foreach ($assets as $a): ?>
                                <tr>
                                    ...
                                    <td>
                                        <?php 
                                        $assetStatus = strtoupper((string)($a['status'] ?? 'NORMAL'));
                                        ...
                                        <?php elseif ($assetStatus === 'BERMASALAH'): ?>
                                    ...
                                    <td class="text-center pe-3">
                                        <div class="btn-group btn-group-sm" role="group">
                                            ...
                                            <?php if (check_role(['administrator', 'admin_ulp', 'inspeksi'])): ?>
                                                ...
                                                <?php if (strtoupper((string)($a['status'] ?? '')) === 'DIHAPUS' || !empty($a['deleted_at'])): ?>
    ...
    <?php if (!empty($pagination) && $pagination['last_page'] > 1): ?>
        <div class="d-flex justify-content-between align-items-center flex-wrap gap-2 p-3 bg-light rounded-4 border mt-3 mb-4">
            <div class="small text-muted font-monospace">
                Menampilkan Halaman <strong><?= $pagination['page'] ?></strong> dari <strong><?= $pagination['last_page'] ?></strong> (Total: <strong><?= number_format($pagination['total'] ?? 0) ?></strong> Aset)
            </div>
            <nav>
