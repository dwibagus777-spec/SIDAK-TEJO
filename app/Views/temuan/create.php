            ...
            <form id="form-create-temuan" action="<?= site_url('temuan/store') ?>" method="post" enctype="multipart/form-data">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group mb-3">
                        ...
                        <textarea name="material" id="material" class="form-control <?= ($validation && $validation->hasError('material')) ? 'is-invalid' : '' ?>" rows="2" placeholder="Sebutkan material yang dibutuhkan (contoh: Isolator Tumpu 2 buah, Tap Connector 3 buah)" required><?= old('material') ?></textarea>
