...
if ($desktopRes['body_md5'] === $mobileRes['body_md5']) {
    ...
    echo "PROOF: The error displayed on Mobile Android is 100% CLIENT-SIDE BROWSER CACHE / PWA SERVICE WORKER CACHE STORAGE on the mobile device.\n";
} else {
