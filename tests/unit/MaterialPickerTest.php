...
final class MaterialPickerTest extends CIUnitTestCase
{
    ...
    private function ensureTablesExist($forge, $db): void
    {
        ...
        if (!$db->tableExists('construction_types')) {
            $forge->addField([
                'id'                  => ['type' => 'INTEGER', 'auto_increment' => true, 'primary_key' => true],
                'construction_code'   => ['type' => 'VARCHAR', 'constraint' => 50, 'null' => true],
                'code'                => ['type' => 'VARCHAR', 'constraint' => 50, 'null' => true],
                'construction_name'   => ['type' => 'VARCHAR', 'constraint' => 150, 'null' => true],
        ...
        if (!$db->tableExists('temuan')) {
            $forge->addField([
                ...
                'prioritas'      => ['type' => 'VARCHAR', 'constraint' => 50, 'null' => true],
